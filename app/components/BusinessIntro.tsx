...
export default function BusinessIntro() {
  ...
  return (
    <section className="py-20 px-4 bg-[#000044]">
      <div className="container mx-auto">
        <h2 className="text-4xl font-bold mb-8 text-center text-cyan-500">{content[language].title}</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {['jobMatching', 'workerCommunity', 'communityBuilding'].map((section) => (
            <div key={section} className="bg-[#000033] p-6 rounded-lg shadow-lg">
              <h3 className="text-2xl font-semibold mb-4 text-white">{content[language][section].title}</h3>
